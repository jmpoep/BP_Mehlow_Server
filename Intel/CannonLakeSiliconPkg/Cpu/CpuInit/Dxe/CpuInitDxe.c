  ...
  )
{
  ...
  if (PcdGetBool (PcdSimicsEnable) == FALSE) {  // @todo: Msr MSR_PLAT_BIOS_INFO_FLAGS is not modeled in Simics to support CNL Z0. Remove this ifdef when support gets added.
    ///
