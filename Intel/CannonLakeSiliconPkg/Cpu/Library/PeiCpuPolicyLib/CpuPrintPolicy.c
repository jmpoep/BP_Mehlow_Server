  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, " BIOS_GUARD_CONFIG:: BiosGuardModulePtr : 0x%X\n", BiosGuardConfig->BiosGuardModulePtr));
  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, " CPU_SGX_CONFIG:: SgxLEPubKeyHash0 : 0x%016llX\n", CpuSgxConfig->SgxLEPubKeyHash0));
  DEBUG ((DEBUG_INFO, " CPU_SGX_CONFIG:: SgxLEPubKeyHash1 : 0x%016llX\n", CpuSgxConfig->SgxLEPubKeyHash1));
  DEBUG ((DEBUG_INFO, " CPU_SGX_CONFIG:: SgxLEPubKeyHash2 : 0x%016llX\n", CpuSgxConfig->SgxLEPubKeyHash2));
  DEBUG ((DEBUG_INFO, " CPU_SGX_CONFIG:: SgxLEPubKeyHash3 : 0x%016llX\n", CpuSgxConfig->SgxLEPubKeyHash3));
  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, " CPU_POWER_MGMT_VR_CONFIG : McivrRfiFreqAdj : 0x%X\n", CpuPowerMgmtVrConfig->McivrRfiFreqAdj));
  DEBUG ((DEBUG_INFO, " CPU_POWER_MGMT_VR_CONFIG : McivrRfiFrequencyPrefix : 0x%X\n", CpuPowerMgmtVrConfig->McivrRfiFrequencyPrefix));
  DEBUG ((DEBUG_INFO, " CPU_POWER_MGMT_VR_CONFIG : McivrSpreadSpectrum : 0x%X\n", CpuPowerMgmtVrConfig->McivrSpreadSpectrum));
  ...
  DEBUG ((DEBUG_INFO, " CPU_POWER_MGMT_VR_CONFIG:: IslVrCmd : 0x%X\n", CpuPowerMgmtVrConfig->IslVrCmd));
}
