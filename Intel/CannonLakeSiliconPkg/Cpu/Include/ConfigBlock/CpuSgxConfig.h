...
typedef struct {
  ...
  UINT8  SgxLCP;                                  ///< Offset 30    SGX Launch Control Policy; <b>0: Locked</b>, 1: Unlocked
  UINT8  Rsvd[1];                                 ///< Offset 31    Reserved for future use and config block alignment
  ...
  UINT64 SgxLEPubKeyHash0;                        ///< Offset 48-55 SGX Launch Enclave Public Key Hash 0; <b>0x0</b> 0: Minimum, 0xFFFFFFFFFFFFFFFF: Maximum
  UINT64 SgxLEPubKeyHash1;                        ///< Offset 56-63 SGX Launch Enclave Public Key Hash 1; <b>0x0</b> 0: Minimum, 0xFFFFFFFFFFFFFFFF: Maximum
  UINT64 SgxLEPubKeyHash2;                        ///< Offset 64-71 SGX Launch Enclave Public Key Hash 2; <b>0x0</b> 0: Minimum, 0xFFFFFFFFFFFFFFFF: Maximum
  UINT64 SgxLEPubKeyHash3;                        ///< Offset 72-77 SGX Launch Enclave Public Key Hash 3; <b>0x0</b> 0: Minimum, 0xFFFFFFFFFFFFFFFF: Maximum
} CPU_SGX_CONFIG;
