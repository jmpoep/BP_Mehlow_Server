...
typedef struct {
  ...
  UINT32                SinitSvn;                 ///< SINIT SE SVN which will be programmed to MSR
  UINT32                SinitAcmBase;             ///< SINIT ACM base address in flash part.
  UINT32                SinitAcmSize;             ///< SINIT ACM size installed in flash part.
