...
#define BIOSGUARD_PRODUCT_ID_OFFSET                         56   ///< Offset of Build Number.
#define BIOSGUARD_BUILD_NUMBER_OFFSET                       58   ///< Offset of Build Number.

#define BGPDT_MAJOR_VERSION         2           ///< BGPDT Major Version
#define BGPDT_MINOR_VERSION         0           ///< BGPDT Minor Version
#ifdef CPU_CFL
#define BIOSGUARD_SVN               0x0001      ///< BIOS Guard Module SVN
#define BIOSGUARD_SGX_SVN           0x0080      ///< BIOS Guard Module SVN for SGX. SGX architecture requires a separate tracking of SVN for BIOS Guard revisions that impact SGX and those that only impact BIOS Guard.
#else
#define BIOSGUARD_SVN               0x0001      ///< BIOS Guard Module SVN
#define BIOSGUARD_SGX_SVN           0x0001      ///< BIOS Guard Module SVN for SGX. SGX architecture requires a separate tracking of SVN for BIOS Guard revisions that impact SGX and those that only impact BIOS Guard.
#endif
...
///
/// Bios Guard attribute defintion
///
typedef enum {
  EnumEcPresent = BIT1,
...
#define MIN_SFAM_COUNT  1       ///< Minumum SFAM Count
