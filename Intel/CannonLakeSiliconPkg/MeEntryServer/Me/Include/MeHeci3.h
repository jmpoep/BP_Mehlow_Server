 ...
 *
 * TODO: Exclude these generic register definitions to separate file shared with IE. : RestrictedContent
 */
...
#define MeHeciPciReadMefs1()                                                  \
        PciSegmentRead32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI1, HECI_R_MEFS1))
#define MeHeciPciReadMefs2()                                                  \
        PciSegmentRead32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI1, HECI_R_MEFS2))
#define MeHeci1MmioRead32(Offset)                                              \
        PciSegmentRead32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI1, Offset))
#define MeHeci1MmioRead16(Offset)                                              \
        PciSegmentRead16 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI1, Offset))
#define MeHeci1MmioRead8(Offset)                                               \
        PciSegmentRead8 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI1, Offset))
#define MeHeci1MmioWrite32(Offset, Value)                                      \
        PciSegmentWrite32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI1, Offset), Value)
#define MeHeci1MmioWrite16(Offset, Value)                                      \
        PciSegmentWrite16 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI1, Offset), Value)
#define MeHeci1MmioWrite8(Offset, Value)                                       \
        PciSegmentWrite8 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI1, Offset), Value)
#define MeHeci2PciRead32(Offset)                                              \
        PciSegmentRead32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI2, Offset))
#define MeHeci2PciRead16(Offset)                                              \
        PciSegmentRead16 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI2, Offset))
#define MeHeci2PciRead8(Offset)                                               \
        PciSegmentRead8 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI2, Offset))
#define MeHeci2PciWrite32(Offset, Value)                                      \
        PciSegmentWrite32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI2, Offset), Value)
#define MeHeci2PciWrite16(Offset, Value)                                      \
        PciSegmentWrite16 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI2, Offset), Value)
#define MeHeci2PciWrite8(Offset, Value)                                       \
        PciSegmentWrite8 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI2, Offset), Value)
#define MeHeci3MmioRead32(Offset)                                              \
        PciSegmentRead32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI3, Offset))
#define MeHeci3MmioRead16(Offset)                                              \
        PciSegmentRead16 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI3, Offset))
#define MeHeci3MmioRead8(Offset)                                               \
        PciSegmentRead8 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI3, Offset))
#define MeHeci3MmioWrite32(Offset, Value)                                      \
        PciSegmentWrite32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI3, Offset), Value)
#define MeHeci3MmioWrite16(Offset, Value)                                      \
        PciSegmentWrite16 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI3, Offset), Value)
#define MeHeci3MmioWrite8(Offset, Value)                                       \
        PciSegmentWrite8 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI3, Offset), Value)
#define MeHeci4MmioRead32(Offset)                                              \
        PciSegmentRead32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI4, Offset))
#define MeHeci4MmioRead16(Offset)                                              \
        PciSegmentRead16 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI4, Offset))
#define MeHeci4MmioRead8(Offset)                                               \
        PciSegmentRead8 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI4, Offset))
#define MeHeci4MmioWrite32(Offset, Value)                                      \
        PciSegmentWrite32 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI4, Offset), Value)
#define MeHeci4MmioWrite16(Offset, Value)                                      \
        PciSegmentWrite16 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI4, Offset), Value)
#define MeHeci4MmioWrite8(Offset, Value)                                       \
        PciSegmentWrite8 (PCI_SEGMENT_LIB_ADDRESS (ME_SEGMENT, ME_BUS, ME_DEV, ME_FUN_HECI4, Offset), Value)
...
#define ME_HECI4_MBAR_DEFAULT 0xFEDB3000
