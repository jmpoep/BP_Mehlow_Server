...
#ifndef CPU_CFL
  Status = GetConfigBlock ((VOID *)SiPolicyPreMemPpi, &gCpuTraceHubConfigGuid, (VOID *) &CpuTraceHubConfig);
  ASSERT_EFI_ERROR (Status);
#endif
...
#ifndef CPU_CFL
  DEBUG ((DEBUG_INFO, " PegImrEnable : 0x%x\n", PciePeiPreMemConfig->PegImrEnable));
  DEBUG ((DEBUG_INFO, " PegImrSize : 0x%x\n", PciePeiPreMemConfig->PegImrSize));
  DEBUG ((DEBUG_INFO, " ImrRpSelection : 0x%x\n", PciePeiPreMemConfig->ImrRpSelection));
#endif
...
#ifndef CPU_CFL
  DEBUG ((DEBUG_INFO, "----------------------- CPU_TRACE_HUB_CONFIG -----------------\n"));
  DEBUG ((DEBUG_INFO, " Revision : %d\n", CpuTraceHubConfig->Header.Revision));
  ASSERT (CpuTraceHubConfig->Header.Revision == CPU_TRACEHUB_CONFIG_REVISION);
  DEBUG ((DEBUG_INFO, " CpuTraceHubConfig->EnableMode : 0x%x\n", CpuTraceHubConfig->EnableMode));
  DEBUG ((DEBUG_INFO, " CpuTraceHubConfig->MemReg0Size : 0x%x\n", CpuTraceHubConfig->CpuTraceHubMemReg0Size));
  DEBUG ((DEBUG_INFO, " CpuTraceHubConfig->MemReg1Size : 0x%x\n", CpuTraceHubConfig->CpuTraceHubMemReg1Size));
#endif
