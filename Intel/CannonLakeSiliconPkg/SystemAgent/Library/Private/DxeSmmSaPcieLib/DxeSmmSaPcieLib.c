  ...
  )
{
  ...
  if ((PciSegmentRead8(DeviceBaseAddress + PCI_PRIMARY_STATUS_OFFSET) & EFI_PCI_STATUS_CAPABILITY) == 0x00) {
    return 0;
  }

  CapHeader = PciSegmentRead8(DeviceBaseAddress + PCI_CAPBILITY_POINTER_OFFSET);

  while (CapHeader != 0 && CapHeader != 0xFF) {
    ///
  ...
  )
{
  ...
  for (RootBridgeCompleted = 0; RootBridgeCompleted < MAX_SUPPORTED_ROOT_BRIDGE_NUMBER; RootBridgeCompleted++) {
    ...
    S3BootScriptSaveMemWrite (
      ...
      PcdGet64 (PcdPciExpressBaseAddress) + PegBaseAddress + PCI_BRIDGE_PRIMARY_BUS_REGISTER_OFFSET,
      1,
        ...
        for (Func =0; Func <=7; Func++) {
          ...
          if (CapOffset2 != 0) {
            ...
            if (mNumberOfDeviceFound [RootBridgeCompleted] >= MAX_SUPPORTED_DEVICE_NUMBER) {
              ...
              S3BootScriptSaveMemWrite (
                S3BootScriptWidthUint32,
                PcdGet64 (PcdPciExpressBaseAddress) + SubDeviceBaseAddress + PCI_BRIDGE_PRIMARY_BUS_REGISTER_OFFSET,
                1,
  ...
  for (RootBridgeIndex = 0; RootBridgeIndex < MAX_SUPPORTED_ROOT_BRIDGE_NUMBER; RootBridgeIndex++) {
    ...
    if ((PciSegmentRead16 (RootPortPcieCapMmBase + 0x12) & BIT12) == 0) {
      ...
      if (CommonClockSupported > 0) {
        ...
        S3BootScriptSaveMemReadWrite (
          ...
          PcdGet64 (PcdPciExpressBaseAddress) + RootPortPcieCapMmBase + 0x10,
        ...
        for (DeviceSearchIndex = 1; DeviceSearchIndex < mNumberOfDeviceFound[RootBridgeIndex]; DeviceSearchIndex++) {
          if (((mDeviceCapMmBaseSave[RootBridgeIndex][DeviceSearchIndex] >> 20) & mMaxBusNumberSupported) == SecBus) {
            ...
            S3BootScriptSaveMemReadWrite (
              S3BootScriptWidthUint8,
              PcdGet64 (PcdPciExpressBaseAddress) + DevicePcieCapMmBase + 0x10,
              &Data16Or,  ///< Data to be ORed
              &Data16And  ///< Data to be ANDed
              );
    ...
    if (LinksToTrainCount > 0) {
      ...
      S3BootScriptSaveMemPoll (
        ...
        PcdGet64 (PcdPciExpressBaseAddress) + DevicePcieCapMmBase + 0x12,
        &Data16Or,
        &Data16And,
        1,
        200000
  ...
  )
{
  ...
  S3BootScriptSaveMemReadWrite (
    S3BootScriptWidthUint16,
    PcdGet64 (PcdPciExpressBaseAddress) + EndpointCapMmBase + 0x28,
    &Data16Or,
    &Data16And
    );
  ...
  if (DeviceCapabilities2 & BIT11) {
    if (mPegPwrOpt[PegFunc].LtrEnable == 1) {
      ...
      if (ExtendedCapOffset != 0) {
        ...
        S3BootScriptSaveMemReadWrite (
          S3BootScriptWidthUint16,
          PcdGet64 (PcdPciExpressBaseAddress) + PegBaseAddress + ExtendedCapOffset + 4,
          &Data16Or,  ///< Data to be ORed
          &Data16And  ///< Data to be ANDed
          );
        ...
        S3BootScriptSaveMemReadWrite (
          S3BootScriptWidthUint16,
          PcdGet64 (PcdPciExpressBaseAddress) + PegBaseAddress + ExtendedCapOffset + 6,
          &Data16Or,  ///< Data to be ORed
          &Data16And  ///< Data to be ANDed
          );
  ...
  )
{
  ...
  S3BootScriptSaveMemWrite (
    S3BootScriptWidthUint8,
    PcdGet64 (PcdPciExpressBaseAddress) + mDeviceCapMmBaseSave [RootBridgeIndex][0] + 0x010,
    1,
  ...
  S3BootScriptSaveMemReadWrite (
    S3BootScriptWidthUint16,
    PcdGet64 (PcdPciExpressBaseAddress) + PegBaseAddress + R_SA_PEG_DCTL2_OFFSET,
    &Data16Or,
    &Data16And
    );
  ...
  while (EndpointCompleted < mNumberOfDeviceFound [RootBridgeIndex]) {
    ...
    S3BootScriptSaveMemWrite (
      S3BootScriptWidthUint8,
      PcdGet64 (PcdPciExpressBaseAddress) + mDeviceCapMmBaseSave [RootBridgeIndex][EndpointCompleted] + 0x010,
      1,
  ...
  )
{
  ...
  if ((mPegAspmPerPort[RootBridgeIndex] != PcieAspmDisabled) && (mCommonClock [RootBridgeIndex] == 1)) {
    ...
    S3BootScriptSaveMemReadWrite (
      S3BootScriptWidthUint32,
      PcdGet64 (PcdPciExpressBaseAddress) + (mDeviceCapMmBaseSave [RootBridgeIndex][0] & (UINT64) ~0xFF) + 0x0AC,
      &Data32Or,  ///< Data to be ORed
      &Data32And  ///< Data to be ANDed
      );
    ...
    S3BootScriptSaveMemReadWrite (
      S3BootScriptWidthUint32,
      PcdGet64 (PcdPciExpressBaseAddress) + (mDeviceCapMmBaseSave [RootBridgeIndex][0] & (UINT64) ~0xFFu) + 0x200,
      &Data32Or,  ///< Data to be ORed
      &Data32And  ///< Data to be ANDed
      );
    ...
    S3BootScriptSaveMemReadWrite (
      S3BootScriptWidthUint32,
      PcdGet64 (PcdPciExpressBaseAddress) + (mDeviceCapMmBaseSave [RootBridgeIndex][0] & (UINT64) ~0xFF) + R_SA_PEG_CFG4_OFFSET,
      &Data32Or,  ///< Data to be ORed
      &Data32And  ///< Data to be ANDed
      );
  }
  ...
  )
{
  ...
  for (RootBridgeCompleted = 0; RootBridgeCompleted < MAX_SUPPORTED_ROOT_BRIDGE_NUMBER; RootBridgeCompleted++) {
    ...
    for (EndpointCompleted = 0; EndpointCompleted < mNumberOfDeviceFound [RootBridgeCompleted]; EndpointCompleted++) {
      ...
      S3BootScriptSaveMemWrite (
        S3BootScriptWidthUint16,
        PcdGet64 (PcdPciExpressBaseAddress) + PcieCapMmBase + 0x8,
        1,
  ...
  )
{
  ...
  if (IsSaving == TRUE) {
    ...
    for (Index = 0; Index < PciRegistersSaveTableSize; Index++) {
      ...
      S3BootScriptSaveMemWrite (
        S3BootScriptWidthUint32,
        PcdGet64 (PcdPciExpressBaseAddress) + PciRegistersSaveTable[Index].Address,
        1,
  ...
  )
{
  ...
  if (IsSaving == TRUE) {
    ...
    for (Index = 0; Index < MAX_PAM_REG_COUNT; Index++) {
      ...
      S3BootScriptSaveMemWrite (
        S3BootScriptWidthUint8,
        PcdGet64 (PcdPciExpressBaseAddress) + McBaseAddress + (PAM_REG_BASE + Index),
        1,
        &mPAMSave[Index]
        );
    }
