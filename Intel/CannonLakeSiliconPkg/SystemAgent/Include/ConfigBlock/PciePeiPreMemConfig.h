...
typedef struct {
  ...
  **/
  ...
  UINT32                 Peg3Enable                      :  2;        ///< <b>(Test)</b> Enable/Disable PEG 0:6:0 Root Port. Applicable on certain CNL- SKUs and newer silicon.
  ...
  **/
  ...
  UINT32                 Peg3MaxLinkSpeed                :  2;        ///< <b>(Test)</b> PCIe Link Speed Control for PEG 0:6:0 Root Port. Applicable on certain CNL- SKUs and newer silicon.
  ...
  **/
  ...
  UINT32                 Peg3MaxLinkWidth                :  3;        ///< <b>(Test)</b> PCIe Link Width Control for PEG 0:6:0 Root Port. Applicable on certain CNL- SKUs and newer silicon.
  /**
  ...
  **/
  ...
  UINT32                 Peg3PowerDownUnusedLanes        :  1;        ///< Power down unused lanes on the PEG 0:6:0 Root Port. Applicable on certain CNL- SKUs and newer silicon.
  ...
  **/
  ...
  UINT32                 Peg3Gen3EqPh2Enable             :  2;        ///< <b>(Test)</b> Phase2 EQ enable on the PEG 0:6:0 Root Port. Applicable on certain CNL- SKUs and newer silicon.
  ...
  **/
  ...
  UINT32                 Peg3Gen3EqPh3Method             :  3;        ///< <b>(Test)</b> Phase3 EQ method on the PEG 0:6:0 Root Port. Applicable on certain CNL- SKUs and newer silicon.
  /**
   Offset 36:12 :
  ...
  **/
  ...
  UINT16                Reserved2;
   ...
   /**
   Offset 160
  From CNL onwards,IMR feature is supported on PEG ports as well. This policy when set to 1, enables the IMR feature support on PEG ports
  **/
  UINT8                  PegImrEnable;
   /**
   Offset 161
  Peg IMR size can be configured using this policy.PegImrSize can vary from 0 to 1024 MB in steps of 2 power N where N = 0 to 10
  **/
  UINT16                 PegImrSize;
   /**
   Offset 163
  ImrRpSelection is used to select the Rp for which the IMR needs to be enabled
  **/
