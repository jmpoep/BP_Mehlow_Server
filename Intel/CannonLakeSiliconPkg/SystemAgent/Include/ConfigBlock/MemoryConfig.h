...
#define MEMORY_CONFIG_REVISION 4
...
typedef struct {
  ...
  UINT32  SharedZqPin:1;                  ///<  - Select if ZQ pin is shared between Rank ranks.  For CFL, this option only works for DDR4.  CNL the option works for LPDDR4 and DDR4. <b>0=Not shared</b>, 1=Shared
  // Thermal Management
  ...
  **/
  ...
  UINT32  LctRelaxedReset:1;            ///< Offset 232 Bit 8: Enable/Disable Relaxed JEDEC Reset during Late Command Training (Only for DDR4): <b>0 = Disabled</b>, 1 = Enabled
