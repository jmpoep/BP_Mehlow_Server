...
#define MRC_NUMBER_OPT_PARAMS_TRAIN        (13)
#define MAX_RCOMP         (3)
...
/*
  ...
  UINT32        DqControl3[MAX_CHANNEL][MAX_SDRAM_IN_DIMM];
  UINT32        DqControl4[MAX_CHANNEL][MAX_SDRAM_IN_DIMM];
  UINT32        DqControl5[MAX_CHANNEL][MAX_SDRAM_IN_DIMM];
  UINT32        DqControl6[MAX_CHANNEL][MAX_SDRAM_IN_DIMM]; // 7 (CS_ARRAY_ENTRIES)
...
#define CS_ARRAY_ENTRIES            (7 * CHANNEL_STROBE_CACHE)
...
#define CACHE_PAD_ENTRIES           (100)
#ifdef MRC_DISABLE_CACHING
#define REGISTER_CACHE_SIZE         1
#define MAX_REGISTER_CACHE_ENTRIES  1
#else
#define REGISTER_CACHE_SIZE (CRS_ARRAY_ENTRIES + CS_ARRAY_ENTRIES + CHANNEL_ARRAY_ENTRIES \
  + CHANNEL_SUBCH_ARRAY_ENTRIES + ODT_CTL_ENTRIES + SINGLE_ENTRIES + CACHE_PAD_ENTRIES)
#define MAX_REGISTER_CACHE_ENTRIES ((REGISTER_CACHE_SIZE<256) ? 256 : REGISTER_CACHE_SIZE)
#endif
...
typedef struct {
  ...
  UINT8                 Ddr4TxDrVefRange[MAX_CHANNEL]; // 0 - Auto, 1 - Range1, 2 - Range2
