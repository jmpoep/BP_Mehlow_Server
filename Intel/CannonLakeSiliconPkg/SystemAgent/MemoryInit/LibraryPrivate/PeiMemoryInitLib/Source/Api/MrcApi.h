...
#define HPET_MIN          (1)  ///< Minimum is one HPET tick = 26.315789ns on CNP PCH
#define HPET_1US          (38)
#define HPET_1MS          (0x9470)
#define HPET_MIN_NS       (27)

#define START_TEST_DELAY  (2 * HPET_MIN)
#define IO_RESET_DELAY    (2 * HPET_MIN)

// Max Possible Vrefs
#define MAX_VREF_OFFSET              63      ///< Maximum possible Vref Offset
#define MAX_POSSIBLE_DDR4_WRITE_VREF 36      ///< Maximum possible margin for DDR4 Write Vref
#define MAX_DDR4_WRITE_VREF_RANGE2   14      ///< Maximum possible DR4 Write Vref for Range2
...
#define MEMORY_RATIO_MIN       4           ///< The minimum DDR ratio value that the hardware supports.
...
#define PCODE_MAILBOX_INTERFACE_OFFSET  BIOS_MAILBOX_INTERFACE_PCU_CNL_REG
#define PCODE_MAILBOX_DATA_OFFSET       BIOS_MAILBOX_DATA_PCU_CNL_REG
