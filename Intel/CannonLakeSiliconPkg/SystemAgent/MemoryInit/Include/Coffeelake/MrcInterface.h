...
typedef struct {
  ...
  UINT32 TeRsv4   : 1;   ///< BIT4 - CNL Reserved
  UINT32 TeRsv5   : 1;   ///< BIT5 - CNL Reserved
  UINT32 TeRsv6   : 1;   ///< BIT6 - CNL Reserved
  UINT32 RsvdBits :25;
} TrainingStepsEn2;
...
//
// This encoding matches CFL/CNL SC_GS_CFG.DRAM_technology and MAD_INTER_CHANNEL.DDR_TYPE registers
//
typedef enum {
  MRC_DDR_TYPE_DDR4     = 0,
  MRC_DDR_TYPE_DDR3     = 1,
...
typedef struct {
  ...
  BOOLEAN             MixedUDimmConfig2Dpc;        ///< Indicates if the system has 2DPC Memory Configuration with Mixed U-DIMM Part Numbers
  BOOLEAN             RelaxedJedecReset;           ///< If set, MrcResetSequence will be executed with default CMD/CTL/CLK timing parameters, at 3N CMD Rate.
#ifdef BDAT_SUPPORT
  union {
...
typedef struct {
  ...
  UINT32  Lp4DqsOscEn:1;                  ///<  - <CNL> DqDqsReTraining support: 0=Disable, <b>1=Enable</b>
  ...
  **/
  ...
  UINT8   Reserved0;              ///< Offset 78 - Reserved for future use. Reserved for CNL
  ...
  UINT8   Reserved3;              ///< Offset 225 - Reserved for CNL. ConfigBlock size must be a multiple of DWORDs
  ...
  UINT8   Reserved4[2];           ///< Offset 230 - 231 Reserved for DWORD alignment. (Offset 230-231 Reserved for CNL)
  UINT32  RmtPerTask:1;                 ///< Offset 232 Bit 0: Rank Margin Tool Per Task. <b>0 = Disabled</b>, 1 = Enabled
  UINT32  Off232Bit1Rsvd:2;             ///< Offset 232 Bit 1-2: Reserved for CNL.
  ...
  UINT32  LctRelaxedReset:1;            ///< Offset 232 Bit 8: Enable/Disable Relaxed JEDEC Reset during Late Command Training (Only for DDR4)
  UINT32  Off232RsvdBits:23;            ///< Offset 232 Bit 9-31: Reserved
