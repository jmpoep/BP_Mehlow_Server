...
typedef enum {
  ...
  CmdTcoCompOffset,             ///< 2s Complement Cmd offset to Tco rise/fall delay. Positive # increases rise delay and each step is 4pS.
  ...
  ClkTcoCompOffset,             ///< 2s Complement Clk offset to Tco rise/fall delay. Positive # increases rise delay and each step is 4pS.
  ...
  CtlTcoCompOffset,             ///< 2s Complement Ctl offset to Tco rise/fall delay. Positive # increases rise delay and each step is 4pS.
  ...
  CkeTcoCompOffset,             ///< 2s Complement Cke offset to Tco rise/fall delay. Positive # increases rise delay and each step is 4pS.
  ...
  TxTcoCompOffset,              ///< 2s Complement Data offset to Tco rise/fall delay. Positive # increases rise delay and each step is 4pS.
  ...
  McOdtDelayLSB,                ///< LSB of the McOdtDelay - bits [3:0]
  McOdtDelayMSB,                ///< MSB of the McOdtDelay - bit [4]
  SenseAmpDelayLSB,             ///< LSB of the SenseAmpDelay - bits [3:0]
  SenseAmpDelayMSB,             ///< MSB of the SenseAmpDelay - bit [4]
  ...
  GsmIocDataVccddqMode,         ///< Mode switch for VCCDDQ.  Project specific values.
  ...
  GsmMctXSRabort,               ///< Self Refresh abort to next valid command delay: tRFCpb + TBDns.  For LPDDR4 with supporting DRAMs.
  GsmMctZQOPER,
  ...
  GsmMccEccMode,
  GsmMccHORI,                   ///< High Order Rank Interleaving Enable.
  GsmMccHORIAddress,            ///< Specify which address bit to use as the rank interlave bit.  Mapping is Memory Controller Specific.
  ...
  GsmMccIgnoreCke,
  GsmMccMaskCs,
  GsmMccCmdMirrorEn,            ///< Mirror a CPGC command on the second sub-channel
  GsmMccCpgcInOrder,
  GsmMccLpddr2nCsMrw,
  GsmMccResetOnCmd,
  GsmMccResetDelay,
