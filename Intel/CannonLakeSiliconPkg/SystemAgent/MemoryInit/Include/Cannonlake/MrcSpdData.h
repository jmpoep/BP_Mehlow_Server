...
typedef struct {
  ...
  SPD_TCCD_L_MIN_MTB_STRUCT           tCCD_Lmin;                ///< 40      Minimum CAS to CAS Delay Time (tCCD_Lmin), same bank group
  UINT8                               Reserved2[116 - 41 + 1];  ///< 41-116  Reserved
  SPD_TCCD_L_MIN_FTB_STRUCT           tCCD_LminFine;            ///< 117     Fine Offset for Minimum CAS to CAS Delay Time (tCCD_Lmin), same bank group
  SPD_TRRD_MIN_FTB_STRUCT             tRRD_LminFine;            ///< 118     Fine Offset for Minimum Activate to Activate Delay Time (tRRD_Lmin), same bank group
  SPD_TRRD_MIN_FTB_STRUCT             tRRD_SminFine;            ///< 119     Fine Offset for Minimum Activate to Activate Delay Time (tRRD_Smin), different bank group
...
typedef union {
  struct {
    UINT8  SignalLoading                       :  2; ///< Bits 1:0
    UINT8  ChannelsPerPackage                  :  2; ///< Bits 3:2
    UINT8  DiePerSdramPackage                  :  3; ///< Bits 6:4
