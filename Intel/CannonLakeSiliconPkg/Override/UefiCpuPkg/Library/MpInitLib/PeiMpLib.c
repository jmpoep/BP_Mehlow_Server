...
#include "MpLib.h"
// SIPO-CNL-0009: Override Begin.
#include <Library/PeiServicesLib.h>
#include <Override/MdeModulePkg/Include/Guid/S3SmmInitDone.h>
  ...
  )
{
  ...
  // mode, if it is not HLT mode, code need set WakeUpByInitSipiSipi
  // so that next time wake up is using INIT-SIPI-SIPI.
  //
