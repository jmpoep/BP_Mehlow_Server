...
typedef enum {
  ...
  MeRecoveryBiosPath = ((RecoveryPath << 24) + HIDE_MEI2 + HIDE_AMT_DEVICE + DID_MSG_ALLOWANCE + MEI_BUS_MSG_ALLOWANCE + DYN_CLIENT_MSG_ALLOWANCE  + HMRFPO_GRP_MSG_ALLOWANCE),
