...
typedef struct {
  ...
  **/
  ...
  UINT32 NmPwrOptBootOverride             : 1;
  UINT32 NmPwrOptBoot                     : 1;
  UINT32 NmCores2DisableOverride          : 1;
  UINT32 BreakRtcEnable                   : 1;
  UINT32 EndOfPostMessage                 : 1;
  UINT32 MeGrLockEnabled                  : 1;
  UINT32 NmPowerMsmtOverride              : 1;
  UINT32 NmHwChangeOverride               : 1;
  UINT32 MeHmrfpoLockEnabled              : 1;
  UINT32 MeHmrfpoEnableEnabled            : 1;
  UINT32 PreDidMeResetEnabled             : 1;
  UINT32 NmCores2Disable                  : 7;
  UINT32 NmHwChangeStatus                 : 1;
  UINT32 NmPtuLoadOverride                : 1;
  UINT32 RsvdBits                         : 2; ///< Reserved for future use & Config block alignment
#else // UP_SPS_SUPPORT
...
#ifdef UP_SPS_SUPPORT
  UINT32 SpsMctpBusOwner                  : 16;
  UINT32 MeInitTimeout                    : 16;
  UINT32 SpsAltitude;
  ...
  UINT32 RsvdBits3                        : 22; ///< Reserved for future use & Config block alignment
#endif // UP_SPS_SUPPORT
