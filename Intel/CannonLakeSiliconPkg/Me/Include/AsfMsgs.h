...
typedef struct {
  ...
  **/
  ...
  UINT16  SpecialCommandParam;          ///< Defines a command parameter to augment the Special Command.
  UINT16  BootOptions;                  ///< Defines a standard set of firmware operations.
  UINT16  OemParameters;                ///< Defines parameters that further augment the Special Command definition.
} ASF_BOOT_OPTIONS;
