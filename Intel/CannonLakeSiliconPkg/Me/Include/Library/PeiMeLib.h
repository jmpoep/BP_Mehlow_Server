...
/**
  ...
  @param[in] ChipsetInitPtr       The ChipsetInitSyncMsg HDR and the required system ChipsetInit Table.
  @param[in] ChipsetInitTableLen  Length of the table in bytes
...
/**
  This function is deprecated. Maintained only for backward compatibility in CNL.
  Retrieves information on whether Pcie Root port SoftStrap override is being done or not
...
/**
  This function is deprecated. Maintained only for backward compatibility in CNL.
  Send message to override Pcie Root port configuration SoftStrap for the specified Root port controller
