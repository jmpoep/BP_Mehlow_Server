...
GLOBAL_REMOVE_IF_UNREFERENCED INTEL_FIRMWARE_VERSION_INFO    mPchFviData[] = {
                                                               ...
                                                               FVI_VERSION (FVI_PCH_CNL_H_A0_HSIO_VERSION),
                                                               FVI_VERSION (FVI_PCH_CNL_H_AX_HSIO_VERSION),
                                                               FVI_VERSION (FVI_PCH_CNL_H_BX_HSIO_VERSION),
                                                               FVI_VERSION (FVI_PCH_CNL_LP_B0_HSIO_VERSION),
                                                               FVI_VERSION (FVI_PCH_CNL_LP_BX_HSIO_VERSION),
                                                               FVI_VERSION (FVI_PCH_CNL_LP_DX_HSIO_VERSION)
                                                             };
GLOBAL_REMOVE_IF_UNREFERENCED FIRMWARE_VERSION_STRINGS       mPchFviStrings[] = {
                                                               ...
                                                               { CNL_PCH_H_A0_HSIO_STRING,  NULL },
                                                               { CNL_PCH_H_AX_HSIO_STRING,  NULL },
                                                               { CNL_PCH_H_BX_HSIO_STRING,  NULL },
                                                               { CNL_PCH_LP_B0_HSIO_STRING, NULL },
                                                               { CNL_PCH_LP_BX_HSIO_STRING, NULL },
                                                               { CNL_PCH_LP_DX_HSIO_STRING, NULL }
                                                             };
