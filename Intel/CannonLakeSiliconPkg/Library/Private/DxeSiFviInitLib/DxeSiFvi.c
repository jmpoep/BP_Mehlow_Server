  ...
  )
{
  ...
  S3BootScriptSaveMemWrite (
    ...
    (UINTN) (PcdGet64 (PcdPciExpressBaseAddress) + McBaseAddress + PCI_REVISION_ID_OFFSET),
    1,
    &Data8
    );
  ...
  if (SiConfigHobData->CsmFlag == 1) {
    ...
    if (Status == EFI_SUCCESS) {
      ...
      SaFviData[VBIOS_VER].Version.MajorVersion = 0;
      SaFviData[VBIOS_VER].Version.MinorVersion = 0;
      SaFviData[VBIOS_VER].Version.Revision = 0;
    }
  }
#endif
