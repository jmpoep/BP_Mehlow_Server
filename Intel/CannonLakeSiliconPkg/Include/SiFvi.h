...
///
#define PCH_FVI_STRING              "Reference Code - CNL PCH"
...
#define CNL_PCH_H_A0_HSIO_STRING     "CNL PCH H A0 Hsio Version"
#define CNL_PCH_H_AX_HSIO_STRING     "CNL PCH H Ax Hsio Version"
#define CNL_PCH_H_BX_HSIO_STRING     "CNL PCH H Bx Hsio Version"
#define CNL_PCH_LP_B0_HSIO_STRING    "CNL PCH LP B0 Hsio Version"
#define CNL_PCH_LP_BX_HSIO_STRING    "CNL PCH LP Bx Hsio Version"
#define CNL_PCH_LP_DX_HSIO_STRING    "CNL PCH LP Dx Hsio Version"
#define RAID_FVI_STRING             "OPROM - RST - RAID"
#define RST_DRIVER_NAME1            L"Intel RST"
#define RST_DRIVER_NAME2            L"Intel(R) RST"

#define FVI_PCH_CNL_H_A0_HSIO_VERSION \
  { \
    CNL_PCH_H_HSIO_VER_A0, 0, 0, 0 \
  }
#define FVI_PCH_CNL_H_AX_HSIO_VERSION \
  { \
    CNL_PCH_H_HSIO_VER_AX, 0, 0, 0 \
  }
#define FVI_PCH_CNL_H_BX_HSIO_VERSION \
  { \
    CNL_PCH_H_HSIO_VER_BX, 0, 0, 0 \
  }
#define FVI_PCH_CNL_LP_B0_HSIO_VERSION \
  { \
    CNL_PCH_LP_HSIO_VER_B0, 0, 0, 0 \
  }
#define FVI_PCH_CNL_LP_BX_HSIO_VERSION \
  { \
    CNL_PCH_LP_HSIO_VER_BX, 0, 0, 0 \
  }
#define FVI_PCH_CNL_LP_DX_HSIO_VERSION \
  { \
    CNL_PCH_LP_HSIO_VER_DX, 0, 0, 0 \
  }
