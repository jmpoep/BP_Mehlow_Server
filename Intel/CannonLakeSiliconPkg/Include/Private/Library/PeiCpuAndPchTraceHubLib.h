...
**/
#ifndef _COMMON_TRACEHUB_LIB_H_
#define _COMMON_TRACEHUB_LIB_H_

#define R_TRACE_HUB_CSR_MTB_LBAR                  0x10
#define R_TRACE_HUB_MTB_SCRPD_0                   0xE0
#define B_TRACE_HUB_MTB_SCRPD_0_DEBUGGER_IN_USE   BIT24

#define R_TRACE_HUB_MTB_MSC0BASE                  0xA0100
#define R_TRACE_HUB_MTB_MSCBAR(n)                 (R_TRACE_HUB_MTB_MSC0BASE + 0x100 * n + 0x08)
#define R_TRACE_HUB_MTB_MSCSIZE(n)                (R_TRACE_HUB_MTB_MSC0BASE + 0x100 * n + 0x0c)
