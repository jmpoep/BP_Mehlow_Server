...
#define B_PCH_PCIE_LTRECH_MSLR_VALUE              0x3FF
#define N_PCH_PCIE_LTRECH_MSLR_VALUE              0
#define B_PCH_PCIE_LTRECH_MSLR_SCALE              0x1C00
#define N_PCH_PCIE_LTRECH_MSLR_SCALE              10

#define R_PCH_PCIE_LTRECH_MNSLR_OFFSET            0x06
#define B_PCH_PCIE_LTRECH_MNSLR_VALUE             0x3FF
#define N_PCH_PCIE_LTRECH_MNSLR_VALUE             0
#define B_PCH_PCIE_LTRECH_MNSLR_SCALE             0x1C00
