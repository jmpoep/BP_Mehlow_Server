...
#define R_DCI_PCR_EARBCTRL                    0x0C            ///< DCI Arbitration Control Register
#define B_DCI_PCR_EARBCTRL_ARB_GNT_DBC        BIT17           ///< DCI Arbitration grant status for DbC
#define B_DCI_PCR_EARBCTRL_ARB_GNT_DCI_OOB    BIT16           ///< DCI Arbitration grant status for DCI OOB
