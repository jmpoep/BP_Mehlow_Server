...
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT1         0x9DB8  ///< PCI Express Root Port #1, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT2         0x9DB9  ///< PCI Express Root Port #2, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT3         0x9DBA  ///< PCI Express Root Port #3, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT4         0x9DBB  ///< PCI Express Root Port #4, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT5         0x9DBC  ///< PCI Express Root Port #5, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT6         0x9DBD  ///< PCI Express Root Port #6, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT7         0x9DBE  ///< PCI Express Root Port #7, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT8         0x9DBF  ///< PCI Express Root Port #8, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT9         0x9DB0  ///< PCI Express Root Port #9, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT10        0x9DB1  ///< PCI Express Root Port #10, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT11        0x9DB2  ///< PCI Express Root Port #11, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT12        0x9DB3  ///< PCI Express Root Port #12, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT13        0x9DB4  ///< PCI Express Root Port #13, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT14        0x9DB5  ///< PCI Express Root Port #14, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT15        0x9DB6  ///< PCI Express Root Port #15, CNL PCH LP PCIe Device ID
#define V_CNL_PCH_LP_PCIE_CFG_DEVICE_ID_PORT16        0x9DB7  ///< PCI Express Root Port #16, CNL PCH LP PCIe Device ID
