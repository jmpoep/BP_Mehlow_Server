...
//
#define PCI_DEVICE_NUMBER_PCH_CNL_SCS_EMMC        26
#define PCI_FUNCTION_NUMBER_PCH_CNL_SCS_EMMC      0
...
//
#define PCI_DEVICE_NUMBER_PCH_CNL_SCS_UFS         18
#define PCI_FUNCTION_NUMBER_PCH_CNL_SCS_UFS       5
