...
//UPServer
#define V_PMC_PWRM_IPC_ME_DISABLE                           0xA9                        ///< IPC command to disable ME devices
...
#define V_PMC_PWRM_IPC_CMD_WBUF0_PROXY_8254CGE                 1                        ///< parameter to access 8254CGE state
#define V_PMC_PWRM_IPC_CMD_WBUF0_PROXY_NMI                     2                        ///< parameter to access NMI control register

#define V_PMC_PWRM_IPC_CMD_COMMAND_PROXY_TO_SOC_REGISTER    0xAA                        ///< Proxy access to SOC registers
#define V_PMC_PWRM_IPC_CMD_CMD_ID_PROXY_TO_SOC_REGISTER_READ   0                        ///< Read command
#define V_PMC_PWRM_IPC_CMD_CMD_ID_PROXY_TO_SOC_REGISTER_WRITE  1                        ///< Write command
#define V_PMC_PWRM_IPC_CMD_WBUF0_PROXY_TO_SOC_REGISTER_8254CGE 1                        ///< parameter to access 8254CGE state
#define V_PMC_PWRM_IPC_CMD_WBUF0_PROXY_TO_SOC_REGISTER_NMI     2                        ///< parameter to access NMI control register
//UPServer
...
#define R_PMC_PWRM_BIOS_SCRATCHPAD                          0x1090           ///< BIOS Scratchpad
#define R_PMC_PWRM_BIOS_SCRATCHPAD_1                        0x1094           ///< BIOS Scratchpad_1
#define B_PMC_PWRM_BIOS_SCRATCHPAD_1_BCLK_S3                BIT1             ///< OC S3 bit indicates BCLK or PLL OC reset occured during S3 resume.
#define R_PMC_PWRM_BIOS_SCRATCHPAD_2                        0x1098           ///< BIOS Scratchpad_2
