...
// IR3D method checks if RTD3 flow is allowed for given device
...
// SSDT RTD3 imports
//
External(\_SB.PCI0.SAT0.PRT0.SPON, MethodObj)
External(\_SB.PCI0.SAT0.PRT1.SPON, MethodObj)
External(\_SB.PCI0.SAT0.PRT2.SPON, MethodObj)
External(\_SB.PCI0.SAT0.PRT3.SPON, MethodObj)
External(\_SB.PCI0.SAT0.PRT4.SPON, MethodObj)
External(\_SB.PCI0.SAT0.PRT5.SPON, MethodObj)
External(\_SB.PCI0.SAT0.PRT0.SPOF, MethodObj)
External(\_SB.PCI0.SAT0.PRT1.SPOF, MethodObj)
External(\_SB.PCI0.SAT0.PRT2.SPOF, MethodObj)
External(\_SB.PCI0.SAT0.PRT3.SPOF, MethodObj)
External(\_SB.PCI0.SAT0.PRT4.SPOF, MethodObj)
External(\_SB.PCI0.SAT0.PRT5.SPOF, MethodObj)
...
Scope(NVM3) {
  Method(IR3D) { Return(PD3C(RAID_VOL_NVM3_MASK)) }
}
...
Method(CPON,1,Serialized,,,{IntObj}) {
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT0.SPON),And(Arg0, RAID_VOL_PRT0_MASK))) { \_SB.PCI0.SAT0.PRT0.SPON() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT1.SPON),And(Arg0, RAID_VOL_PRT1_MASK))) { \_SB.PCI0.SAT0.PRT1.SPON() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT2.SPON),And(Arg0, RAID_VOL_PRT2_MASK))) { \_SB.PCI0.SAT0.PRT2.SPON() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT3.SPON),And(Arg0, RAID_VOL_PRT3_MASK))) { \_SB.PCI0.SAT0.PRT3.SPON() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT4.SPON),And(Arg0, RAID_VOL_PRT4_MASK))) { \_SB.PCI0.SAT0.PRT4.SPON() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT5.SPON),And(Arg0, RAID_VOL_PRT5_MASK))) { \_SB.PCI0.SAT0.PRT5.SPON() }
  // Remapped PCIe
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM1.RPON),And(Arg0, RAID_VOL_NVM1_MASK))) { \_SB.PCI0.SAT0.NVM1.RPON() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM1.NVD0),And(Arg0, RAID_VOL_NVM1_MASK))) { \_SB.PCI0.SAT0.NVM1.NVD0() }

  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM2.RPON),And(Arg0, RAID_VOL_NVM2_MASK))) { \_SB.PCI0.SAT0.NVM2.RPON() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM2.NVD0),And(Arg0, RAID_VOL_NVM2_MASK))) { \_SB.PCI0.SAT0.NVM2.NVD0() }

  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM3.RPON),And(Arg0, RAID_VOL_NVM3_MASK))) { \_SB.PCI0.SAT0.NVM3.RPON() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM3.NVD0),And(Arg0, RAID_VOL_NVM3_MASK))) { \_SB.PCI0.SAT0.NVM3.NVD0() }
}

// CPOF  : Method to turn OFF ports per PMAP bitmap status
// Arg0 : PMAP - Port Bitmap Status
Method(CPOF,1,Serialized,,,{IntObj}) {
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT0.SPOF),And(Arg0, RAID_VOL_PRT0_MASK))) { \_SB.PCI0.SAT0.PRT0.SPOF() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT1.SPOF),And(Arg0, RAID_VOL_PRT1_MASK))) { \_SB.PCI0.SAT0.PRT1.SPOF() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT2.SPOF),And(Arg0, RAID_VOL_PRT2_MASK))) { \_SB.PCI0.SAT0.PRT2.SPOF() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT3.SPOF),And(Arg0, RAID_VOL_PRT3_MASK))) { \_SB.PCI0.SAT0.PRT3.SPOF() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT4.SPOF),And(Arg0, RAID_VOL_PRT4_MASK))) { \_SB.PCI0.SAT0.PRT4.SPOF() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.PRT5.SPOF),And(Arg0, RAID_VOL_PRT5_MASK))) { \_SB.PCI0.SAT0.PRT5.SPOF() }
  // Remapped PCIe
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM1.NVD3),And(Arg0, RAID_VOL_NVM1_MASK))) { \_SB.PCI0.SAT0.NVM1.NVD3() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM1.RPOF),And(Arg0, RAID_VOL_NVM1_MASK))) { \_SB.PCI0.SAT0.NVM1.RPOF() }

  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM2.NVD3),And(Arg0, RAID_VOL_NVM2_MASK))) { \_SB.PCI0.SAT0.NVM2.NVD3() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM2.RPOF),And(Arg0, RAID_VOL_NVM2_MASK))) { \_SB.PCI0.SAT0.NVM2.RPOF() }

  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM3.NVD3),And(Arg0, RAID_VOL_NVM3_MASK))) { \_SB.PCI0.SAT0.NVM3.NVD3() }
  If(LAnd(CondRefOf(\_SB.PCI0.SAT0.NVM3.RPOF),And(Arg0, RAID_VOL_NVM3_MASK))) { \_SB.PCI0.SAT0.NVM3.RPOF() }
}
