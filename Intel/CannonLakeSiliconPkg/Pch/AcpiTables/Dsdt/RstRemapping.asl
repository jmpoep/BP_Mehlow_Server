...
External(\_SB.PCI0.RP05.POFF, MethodObj)
External(\_SB.PCI0.RP07.PON, MethodObj)
External(\_SB.PCI0.RP07.POFF, MethodObj)
External(\_SB.PCI0.RP09.PON, MethodObj)
External(\_SB.PCI0.RP09.POFF, MethodObj)
External(\_SB.PCI0.RP11.PON, MethodObj)
External(\_SB.PCI0.RP11.POFF, MethodObj)
External(\_SB.PCI0.RP13.PON, MethodObj)
External(\_SB.PCI0.RP13.POFF, MethodObj)
External(\_SB.PCI0.RP15.PON, MethodObj)
External(\_SB.PCI0.RP15.POFF, MethodObj)
External(\_SB.PCI0.RP17.PON, MethodObj)
External(\_SB.PCI0.RP17.POFF, MethodObj)
External(\_SB.PCI0.RP19.PON, MethodObj)
External(\_SB.PCI0.RP19.POFF, MethodObj)
External(\_SB.PCI0.RP21.PON, MethodObj)
External(\_SB.PCI0.RP21.POFF, MethodObj)
External(\_SB.PCI0.RP23.PON, MethodObj)
External(\_SB.PCI0.RP23.POFF, MethodObj)
...
Method(RDCA, 5, Serialized) {
  ...
  //
  OperationRegion(RPAL, SystemMemory, Add(\_SB.PCI0.GPCB(), Add(Add(0xB8000, V_SATA_CFG_RST_PCIE_STORAGE_REMAP_RP_OFFSET),Arg1)), 0x4)
  ...
  //
  OperationRegion(EPAC, SystemMemory, Add(\_SB.PCI0.GPCB(), Add(0xB8000, R_SATA_CFG_RST_PCIE_STORAGE_CAIR)), 0x8)
  ...
  //
  OperationRegion(NCRG, SystemMemory, Add(\_SB.PCI0.GPCB(), Add(0xB8000, R_SATA_CFG_RST_PCIE_STORAGE_CRGC)), 0x4)
...
Method(D3CS, 1, Serialized) {
  Switch(Arg0) {
    Case(4) {
      If(CondRefOf(\_SB.PCI0.RP05.POFF)) {Return(1)}
    }
    Case(6) {
      If(CondRefOf(\_SB.PCI0.RP07.POFF)) {Return(1)}
    }
    Case(8) {
      If(CondRefOf(\_SB.PCI0.RP09.POFF)) {Return(1)}
    }
    Case(10) {
      If(CondRefOf(\_SB.PCI0.RP11.POFF)) {Return(1)}
    }
    Case(12) {
      If(CondRefOf(\_SB.PCI0.RP13.POFF)) {Return(1)}
    }
    Case(14) {
      If(CondRefOf(\_SB.PCI0.RP15.POFF)) {Return(1)}
    }
    Case(16) {
      If(CondRefOf(\_SB.PCI0.RP17.POFF)) {Return(1)}
    }
    Case(18) {
      If(CondRefOf(\_SB.PCI0.RP19.POFF)) {Return(1)}
    }
    Case(20) {
      If(CondRefOf(\_SB.PCI0.RP21.POFF)) {Return(1)}
    }
    Case(22) {
      If(CondRefOf(\_SB.PCI0.RP23.POFF)) {Return(1)}
    }
  }
  Return(0)
}
...
Method(RSON, 1, Serialized) {
  Switch(Arg0) {
    Case(4) {
      If(CondRefOf(\_SB.PCI0.RP05.PON)) {\_SB.PCI0.RP05.PON()}
    }
    Case(6) {
      If(CondRefOf(\_SB.PCI0.RP07.PON)) {\_SB.PCI0.RP07.PON()}
    }
    Case(8) {
      If(CondRefOf(\_SB.PCI0.RP09.PON)) {\_SB.PCI0.RP09.PON()}
    }
    Case(10) {
      If(CondRefOf(\_SB.PCI0.RP11.PON)) {\_SB.PCI0.RP11.PON()}
    }
    Case(12) {
      If(CondRefOf(\_SB.PCI0.RP13.PON)) {\_SB.PCI0.RP13.PON()}
    }
    Case(14) {
      If(CondRefOf(\_SB.PCI0.RP15.PON)) {\_SB.PCI0.RP15.PON()}
    }
    Case(16) {
      If(CondRefOf(\_SB.PCI0.RP17.PON)) {\_SB.PCI0.RP17.PON()}
    }
    Case(18) {
      If(CondRefOf(\_SB.PCI0.RP19.PON)) {\_SB.PCI0.RP19.PON()}
    }
    Case(20) {
      If(CondRefOf(\_SB.PCI0.RP21.PON)) {\_SB.PCI0.RP21.PON()}
    }
    Case(22) {
      If(CondRefOf(\_SB.PCI0.RP23.PON)) {\_SB.PCI0.RP23.PON()}
    }
  }
}
...
Method(RSOF, 1, Serialized) {
  Switch(Arg0) {
    Case(4) {
      If(CondRefOf(\_SB.PCI0.RP05.POFF)) {\_SB.PCI0.RP05.POFF()}
    }
    Case(6) {
      If(CondRefOf(\_SB.PCI0.RP07.POFF)) {\_SB.PCI0.RP07.POFF()}
    }
    Case(8) {
      If(CondRefOf(\_SB.PCI0.RP09.POFF)) {\_SB.PCI0.RP09.POFF()}
    }
    Case(10) {
      If(CondRefOf(\_SB.PCI0.RP11.POFF)) {\_SB.PCI0.RP11.POFF()}
    }
    Case(12) {
      If(CondRefOf(\_SB.PCI0.RP13.POFF)) {\_SB.PCI0.RP13.POFF()}
    }
    Case(14) {
      If(CondRefOf(\_SB.PCI0.RP15.POFF)) {\_SB.PCI0.RP15.POFF()}
    }
    Case(16) {
      If(CondRefOf(\_SB.PCI0.RP17.POFF)) {\_SB.PCI0.RP17.POFF()}
    }
    Case(18) {
      If(CondRefOf(\_SB.PCI0.RP19.POFF)) {\_SB.PCI0.RP19.POFF()}
    }
    Case(20) {
      If(CondRefOf(\_SB.PCI0.RP21.POFF)) {\_SB.PCI0.RP21.POFF()}
    }
    Case(22) {
      If(CondRefOf(\_SB.PCI0.RP23.POFF)) {\_SB.PCI0.RP23.POFF()}
    }
  }
}
