...
{
#ifdef CPU_CFL
  return PmcGet8254ClockGateState (ClockGeteState);
#else
...
{
#ifdef CPU_CFL
  return PmcSet8254ClockGateState (ClockGateEnable);
#else
  PchPcrAndThenOr32 (PID_ITSS, R_ITSS_PCR_ITSSPRC, ~0u, B_ITSS_PCR_ITSSPRC_8254CGE);
  return EFI_SUCCESS;
#endif // CPU_CFL
}
