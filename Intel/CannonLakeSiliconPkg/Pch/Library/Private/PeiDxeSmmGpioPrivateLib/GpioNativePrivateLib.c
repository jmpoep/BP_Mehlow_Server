...
#ifdef UP_SERVER_FLAG
/* // FIXME: Find proper solution for sighting: 2006651050
...
#ifdef UP_SPS_SUPPORT
    GpioGetPadOwnership (SmbusGpio[Index].Pad, &PadOwnVal);
    if (PadOwnVal != GpioPadOwnHost) {
      DEBUG ((DEBUG_INFO, "SMBUS controller pin not configurable from host. \n"));
      continue; 
    }
#endif
