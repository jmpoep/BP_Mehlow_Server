...
//
GLOBAL_REMOVE_IF_UNREFERENCED CONST PCH_DEV_INT_INFO mPchHDeviceInterruptInfo[] = {
  {18, 0, VALID_DEV_YES, INTERRUPT_YES, USES_PIRQ_YES, INTP_MUST_SET, IRQ_UNIQUE_NO  }, // Thermal Subsystem
  ...
  {18, 5, VALID_DEV_YES, INTERRUPT_YES, USES_PIRQ_NO , INTP_NO_REQ  , IRQ_UNIQUE_NO  }, // SCS: UFS
  ...
  {20, 5, VALID_DEV_YES, INTERRUPT_YES, USES_PIRQ_NO , INTP_NO_REQ  , IRQ_UNIQUE_NO  }, // SCS: SDCard
...
GLOBAL_REMOVE_IF_UNREFERENCED UINT32 mPchHDeviceInterruptInfoSize = ARRAY_SIZE (mPchHDeviceInterruptInfo);
