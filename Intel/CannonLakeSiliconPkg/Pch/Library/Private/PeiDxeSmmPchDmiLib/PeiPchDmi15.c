  ...
  )
{
  switch (Vc) {
    case DmiVcTypeVc0:
      *DmiVcCtlAddress = R_PCH_DMI15_PCR_V0CTL;
      *DmiVcStsAddress = R_PCH_DMI15_PCR_V0STS;
      break;

    case DmiVcTypeVc1:
      *DmiVcCtlAddress = R_PCH_DMI15_PCR_V1CTL;
      *DmiVcStsAddress = R_PCH_DMI15_PCR_V1STS;
      break;

    case DmiVcTypeVcm:
      *DmiVcCtlAddress = R_PCH_DMI15_PCR_VMCTL;
      *DmiVcStsAddress = R_PCH_DMI15_PCR_VMSTS;
      break;
  ...
  )
{
  ...
  PchPcrAndThenOr32 (
    ...
    ((20 << N_PCH_DMI15_PCR_PCIEL0SC_G2ASL0SPL) |
    (20 << N_PCH_DMI15_PCR_PCIEL0SC_G1ASL0SPL))
    );
  ...
  PchPcrAndThenOr32 (
    ...
    ((40 << N_PCH_DMI15_PCR_G3L0SCTL_G3ASL0SPL) |
...
#ifndef CPU_CFL
  if (IsPchH () && ((CpuSteppingId == EnumCnlP0) || (CpuSteppingId == EnumCnlG0))) {
...
/**
  This function performs early P-DMI SIP15 init.
...
/**
  The function set the Target Link Speed in P-DMI to GEN 3.
