  ...
  )
{
  ...
  Data32Or =  (UINT32) ((InterruptPin << N_ISH_PCR_PCICFGCTR_IPIN1) |
                        (Irq << N_ISH_PCR_PCICFGCTR_PCI_IRQ));
  Data32And =~(UINT32) (B_ISH_PCR_PCICFGCTR_PCI_IRQ | B_ISH_PCR_PCICFGCTR_ACPI_IRQ | B_ISH_PCR_PCICFGCTR_IPIN1);
