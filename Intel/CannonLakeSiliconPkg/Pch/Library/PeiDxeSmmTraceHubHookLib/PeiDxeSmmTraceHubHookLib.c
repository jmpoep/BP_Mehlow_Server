...
#define R_TRACE_HUB_MTB_SCRPD_2           0xE8
...
{
  if ((MmioRead32 (PCH_TRACE_HUB_FW_BASE_ADDRESS) == 0xFFFFFFFF)) {
  ...
  )
{
  ...
  *ScratchPad2RegValue = MmioRead8 (PCH_TRACE_HUB_MTB_BASE_ADDRESS + R_TRACE_HUB_MTB_SCRPD_2);
