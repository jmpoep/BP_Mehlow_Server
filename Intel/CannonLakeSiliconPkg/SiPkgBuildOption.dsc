...
!if gSiPkgTokenSpaceGuid.PcdSimicsEnable == TRUE
  DEFINE SIMICS_BUILD_OPTIONS = -DSIMICS_FLAG
!else
...
# UP_SPS_SUPPORT
#
!if gSiPkgTokenSpaceGuid.PcdSpsEnable == TRUE
  DEFINE DSC_AMT_BUILD_OPTIONS =
  !if gSiPkgTokenSpaceGuid.PcdSpsCflSimicsEnable == TRUE
    DEFINE DSC_AMT_BUILD_OPTIONS = -DCFL_SIMICS
  !endif
!endif
# 
# UP_SPS_SUPPORT
#
DEFINE DSC_SIPKG_FEATURE_BUILD_OPTIONS = $(BDAT_BUILD_OPTION) $(PTT_BUILD_OPTION) $(DEBUG_BUILD_OPTIONS) $(DSC_AMT_BUILD_OPTIONS)
